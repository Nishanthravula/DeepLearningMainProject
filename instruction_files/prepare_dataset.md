...
1. Direct downloading
      ...
      -  The **calibration and pose** files from semanticEx/Extraction/extracted_data_calib/sequences.
...
2. Downloading the voxel and image data first, then following the commands in *semanticEx/preprocess* to create **labels** and **sequences_msnet3d_sweep10**. You need to choose this option if you would like to use different data or depth models.
